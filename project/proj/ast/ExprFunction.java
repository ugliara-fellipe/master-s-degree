 ...
 *
 */
abstract public class ExprFunction extends Expr implements IExprFunction {
	...
	/**
	 * Generates the Java class that contains the body of the function in its eval method.
	 * @param pw
	 * @param env
	 */
	abstract public void genJavaClassForFunction(PWInterface pw, Env env);
	...
	public ArrayList<StatementReturnFunction> getStatementReturnFunctionList() {
	...
	public ArrayList<StatementReturn> getStatementReturnList() {
	...
	protected void calcReturnType(Env env) {
		...
		ArrayList<Type> returnTypeList = new ArrayList<Type>();
		ArrayList<Expr> returnTypeExprList = new ArrayList<Expr>();
	...
	protected ProgramUnit createGenericPrototype(String prototypeName, ArrayList<ArrayList<Expr>> realTypeListList,
			Env env) {
	...
	public void calcInternalTypes(Env env) {
		...
		if ( innerObjectForThisFunction != null && env.getProject().getCompilerManager().getCompilationStep() == CompilationStep.step_9 ) {
			if ( innerObjectForThisFunction.getSuperobjectExpr() instanceof ast.ExprGenericPrototypeInstantiation ) {
				...
				ArrayList<ArrayList<Expr>> rtListList = e.getRealTypeListList();
				int sizeListList = rtListList.size();
				ArrayList<Expr> rtList = rtListList.get(sizeListList - 1);
	...
	public void endCalcInternalTypes() {
		/**
	...
	public String genJavaExpr(PWInterface pw, Env env) {
		String functionType = NameServer.getJavaName(this.functionPrototypeName);
	...
	public ArrayList<Tuple6<String, VariableDecInterface, Type, Type, String, String>> getVarNameNewCodeOldCodeList() {
		return varNameNewCodeOldCodeList;
	}	

	public ArrayList<VariableDecInterface> getAccessedVariableParameters() {
	 ...
	 */
	protected ArrayList<ParameterDec> accessedParameterList;
	
	
	/**
	 * the local variables of the outer method and outer functions that are accessed by this function
	 */
	protected ArrayList<StatementLocalVariableDec> accessedLocalVariables;
	 ...
	 * if this is a function with selectors such as 
	 ...
	 */
	private ArrayList<VariableDecInterface> localVariableDecList;

	/**
	 * list of statements of the kind "^ expr". That is, return
	 * statement from this function
	 */
	protected ArrayList<StatementReturnFunction> statementReturnFunctionList;
	 ...
	 * 
	 */
	protected ArrayList<StatementReturn> statementReturnList;	
	 ...
	 */
	private ArrayList<Tuple6<String, VariableDecInterface, Type, Type, String, String>> varNameNewCodeOldCodeList;

	/**
	 * contains all external accessed variables and parameters by this function
	 */

	protected ArrayList<VariableDecInterface> accessedVariableParameters;
