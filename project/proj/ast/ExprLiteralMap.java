...
public class ExprLiteralMap extends ExprAnyLiteral {
	...
	public String genJavaExpr(PWInterface pw, Env env) {
		...
		String javaArrayType = NameServer.getJavaName("HashMap<" + keyType.getFullName() + ", "
				+ valueType.getFullName() 
		   + ">"); 
		String other = this.type.getFullName();
	...
	*/
	...
	public void calcInternalTypes(Env env) {
		...
		if ( (keyType instanceof ProgramUnit || keyType == Type.Dyn) && 
				(valueType instanceof ProgramUnit || valueType == Type.Dyn) ) {
			...
			type = null;
			ArrayList<Expr> interfaceExprList = ((ObjectDec ) CompilerManager.createGenericPrototype(gpi, env)).getInterfaceList();
