...
public class GenericParameter {
	...
	public String getNameSourceFile() {
		...
		return sourceFileName.replace(NameServer.cyanLanguagePackageName + ".", "");
	...
	public String getFullName(Env env) {
		...
		if ( fullName == null ) {
			if ( kind == GenericParameterKind.LowerCaseSymbol ||  kind == GenericParameterKind.FormalParameter ) {
				...
				Tuple<String, Type> t = parameter.ifPrototypeReturnsNameWithPackageAndType(env);
				if ( t == null || t.f2 == null ) {
					ProgramUnit pu = null;
		...
		ProgramUnit paramType = (ProgramUnit ) t;
