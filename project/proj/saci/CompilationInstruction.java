 ...
 * set of {@link saci.CompilationInstruction} objects associated to it.
...
public enum CompilationInstruction {
	...
	dpa_actions,
	/**
	 * ati actions are allowed. ati = After Typing Interfaces
	 */
	ati_actions,
	/**
	...
	dsa_check,
	/**
	 * check actions made at the end of step 5 of the compilation, calculate interfaces. Therefore, after typing interfaces (ati)
	 */
	ati2_check,
	/**
	 * check actions made at the end of step 8 of the compilation, calculate interfaces. Therefore, after typing interfaces (ati)
	 */
	ati3_check,
	/**
