 ...
 *         fun test [ y = 0 ]  // y is not an instance variable
 *
...
public enum ErrorKind {
	...
	unreachable_code( "Unreachabel code", new String [] {
			...
			"visibleLocalVariableList", "instanceVariableList", "methodList" } ),
	...
	identifier_was_not_declared_outside_method( "Identifier expected", new String [] { "identifier",
							"prototypeName", "supertype", "implementedInterfaces", "instanceVariableList", "methodList" } ),
	...
	instance_variable_is_not_visible_here( "Instance variable is not visible here", new String [] { "identifier",
	    "prototypeName", "supertype", "implementedInterfaces", "instanceVariableList", "methodList", "statementText" } ),
    ...
    prototype_was_not_found_inside_method("Prototype was not found", new String [] { "identifier",
		...
		// instance variable type. Or in a clause 'extends' or 'mixin'
	...
	two_or_more_init_methods("Two or more 'init' methods. There should be only one",
			new String [] { "identifier",
			"prototypeName", "supertype", "implementedInterfaces", "instanceVariableList", "methodSignature", "methodList" } ),
	...
	init_should_return_Nil("Method 'init' should return 'Nil' or nothing at all",
					new String [] { "identifier",
					"prototypeName", "supertype", "implementedInterfaces", "instanceVariableList", "methodSignature", "methodList", "returnType" } ),
	...
	init_should_not_be_abstract("Method 'init' should not be preceded by 'override'",
			new String [] { "identifier", "prototypeName", "supertype", "implementedInterfaces", "methodSignature", "instanceVariableList", "methodList" } ),
	init_new_should_not_appear_in_grammar_method("'init:' and 'new:' selectors cannot appear in a grammar method",
			new String [] { "identifier",
			"prototypeName", "supertype", "implementedInterfaces", "instanceVariableList", "methodSignature", "methodList" } ),
	init_new_cannot_be_preceded_by_indexing_operator("'init:' and 'new:' selectors cannot be used with indexing operator '[]'",
					new String [] { "identifier",
					"prototypeName", "supertype", "implementedInterfaces",
					"instanceVariableList", "methodSignature", "methodList" } ),
	...
	method_should_be_declared_after_previous_method_with_the_same_selectors(
			"Method should be declared after method with the same selectors",
			new String [] { "identifier",
			"prototypeName", "supertype", "implementedInterfaces", "instanceVariableList", "methodList", "method0", "method1" } ),
	...
	method_is_overridden_method_with_different_visibility(
					...
					new String [] { "identifier",
					"prototypeName", "supertype", "implementedInterfaces",
					"instanceVariableList", "methodList", "method0", "method1" } ),
	methods_with_the_same_selectors_with_and_without_override(
							"Methods with the same selectors should be declared both with 'override' or both without 'override'",
							new String [] { "identifier",
							"prototypeName", "supertype", "implementedInterfaces",
							"instanceVariableList", "methodList", "method0", "method1" } ),
	methods_with_the_same_selectors_with_and_without_final(
		"Methods with the same selectors should be declared both with 'final' or both without 'final'",
		new String [] { "identifier",
		   "prototypeName", "supertype", "implementedInterfaces",
		   "instanceVariableList", "methodList", "method0", "method1" } ),


    methods_with_the_same_selectors_and_different_return_types(
					"Methods with the same selectors should be declared with the same return type",
					new String [] { "identifier",
					"prototypeName", "supertype", "implementedInterfaces",
					"instanceVariableList", "methodList", "method0", "method1" } ),

    methods_with_the_same_selectors_and_different_visibilities(
		"Methods with the same selectors should be declared with the same visibility",
		new String [] { "identifier", "prototypeName", "supertype", "implementedInterfaces",
				"instanceVariableList", "methodList", "method0", "method1" } ),
    ...
    override_without_supertype("'override' cannot be used without a supertype",
         new String [] { "identifier", "methodSignature",
    	   "prototypeName",  "implementedInterfaces", "instanceVariableList", "methodList" }),
    ...
    method_was_not_found_in_prototype_or_super_prototypes("Method was not found in the receiver´s prototype or in its super-prototypes",
			...
			"visibleLocalVariableList", "instanceVariableList", "methodList", "method0",
	...
	type_error_return_value_type_is_not_a_subtype_of_the_method_return_type("Type error: the type of the returned value is not a subtype of the method return type",
			new String[] { "statementText", "methodSignature", "prototypeName", "supertype", "implementedInterfaces",
			"visibleLocalVariableList", "instanceVariableList", "methodList", "returnType" } ),
